...
namespace NakhleNakhoda.Migrations
{
    ...
    [Migration("20230325140847_Mig_Users")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.Permissions.Permission", b =>
                {
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.Permissions.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.User.Role2", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.User.User", b =>
                {
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.User.UserRole", b =>
                {
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.Permissions.Permission", b =>
                {
                    b.HasOne("NakhleNakhoda.Data.Models.DB.Permissions.Permission", null)
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.Permissions.RolePermission", b =>
                {
                    b.HasOne("NakhleNakhoda.Data.Models.DB.Permissions.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NakhleNakhoda.Data.Models.DB.User.Role2", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("NakhleNakhoda.Data.Models.DB.User.UserRole", b =>
                {
                    ...
                    b.HasOne("NakhleNakhoda.Data.Models.DB.User.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("NakhleNakhoda.Domain.Identity.MemberClaim", b =>
                {
                    b.HasOne("NakhleNakhoda.Domain.Identity.Member", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("NakhleNakhoda.Domain.Identity.MemberRole", b =>
                {
                    b.HasOne("NakhleNakhoda.Domain.Identity.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
