...
namespace NakhleNakhoda.Services.Infrastructure
{
    ...
    public class CustomFileProvider : PhysicalFileProvider, ICustomFileProvider
    {
        ...
        public CustomFileProvider(IWebHostEnvironment webHostEnvironment)
        ...
        /// <param name="destFileName">The name of the Location file. This cannot be a directory</param>
        /// <param name="overwrite">true if the Location file can be overwritten; otherwise, false</param>
