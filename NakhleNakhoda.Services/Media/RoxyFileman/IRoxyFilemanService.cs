namespace NakhleNakhoda.Services.Media.RoxyFileman
{
    ...
    public interface IRoxyFilemanService
    {
        ...
        Task CopyDirectoryAsync(string sourcePath, string LocationPath);
        ...
        /// <param name="LocationPath">Path to the Location directory</param>
        /// <returns>A task that represents the completion of the operation</returns>
        Task MoveDirectoryAsync(string sourcePath, string LocationPath);
        ...
        /// <returns>A task that represents the completion of the operation</returns>
        Task CopyFileAsync(string sourcePath, string LocationPath);
        ...
        /// <param name="LocationPath">Path to the Location file</param>
        /// <returns>A task that represents the completion of the operation</returns>
        Task MoveFileAsync(string sourcePath, string LocationPath);
