...
namespace NakhleNakhoda.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("admin-label", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AdminLabelTagHelper : TagHelper
    {
        ...
        public AdminLabelTagHelper(IHtmlGenerator generator)
        {
            Generator = generator;
        }
