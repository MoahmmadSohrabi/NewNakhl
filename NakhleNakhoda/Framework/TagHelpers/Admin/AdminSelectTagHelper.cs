...
{
    /// <summary>
    /// admin-select tag helper
    /// </summary>
    [HtmlTargetElement("admin-select", TagStructure = TagStructure.WithoutEndTag)]
    public class AdminSelectTagHelper : TagHelper
    {
        ...
        public AdminSelectTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //required asterisk
            _ = bool.TryParse(IsRequired, out bool required);
            if (required)
            {
            ...
            _ = bool.TryParse(IsMultiple, out bool multiple);
