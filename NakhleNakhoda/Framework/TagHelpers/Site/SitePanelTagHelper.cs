...
{
    /// <summary>
    /// "site-panel tag helper
    /// </summary>
    [HtmlTargetElement("site-panel", Attributes = NAME_ATTRIBUTE_NAME)]
    public class SitePanelTagHelper : TagHelper
    {
        ...
        public SitePanelTagHelper(IHtmlHelper htmlHelper)
        {
