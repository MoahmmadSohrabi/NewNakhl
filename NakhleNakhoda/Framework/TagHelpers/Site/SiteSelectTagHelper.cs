...
{
    /// <summary>
    /// site-select tag helper
    /// </summary>
    [HtmlTargetElement("site-select", TagStructure = TagStructure.WithoutEndTag)]
    public class SiteSelectTagHelper : TagHelper
    {
        ...
        public SiteSelectTagHelper(IHtmlHelper htmlHelper)
        {
