...
var handleNakhleNakhodaChart = function () {
	'use strict';
	
	$('#NakhleNakhoda-chart').empty();
	var sin = [], cos = [];
	...
	if ($('#NakhleNakhoda-chart').length !== 0) {
		var plot = $.plot($('#NakhleNakhoda-chart'), [ 
		...
		var legends = $('#NakhleNakhoda-chart .legendLabel');
		...
		$('#NakhleNakhoda-chart').bind('plothover',  function (pos) {
			latestPosition = pos;
