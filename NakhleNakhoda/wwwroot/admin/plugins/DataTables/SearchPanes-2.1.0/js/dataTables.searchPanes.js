...
(function () {
    ...
    var SearchPaneST = /** @class */ (function (_super) {
        ...
        /**
         * Remove functionality from makeSelection - needs to be more advanced when NakhleNakhoda selections
         */
        SearchPaneST.prototype._makeSelection = function () {
            return;
        };
        /**
         * Blank method to remove reloading of selected rows - needs to be more advanced when NakhleNakhoda selections
         */
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            table.off('page.dtsps page-nc.dtsps').on('page.dtsps page-nc.dtsps', function (e, s) {
                _this.s.paging = true;
                // This is an indicator to any selection NakhleNakhoda classes that paging has occured
    ...
    var SearchPanesST = /** @class */ (function (_super) {
        ...
        /**
         * Ensures that the correct selection listeners are set for selection NakhleNakhoda
         *
